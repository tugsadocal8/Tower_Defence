...
public class DwarfDragDrop : MonoBehaviour, IPointerDownHandler, IBeginDragHandler, IEndDragHandler, IDragHandler, IDropHandler
{
    [SerializeField] 
    ...
    public void OnBeginDrag(PointerEventData eventData)
    {
        ...
        circle.transform.localScale *=  dwarfRange* 2;
    }
    ...
    public void OnEndDrag(PointerEventData eventData)
    {
        ...
        if (Physics.Raycast(ray, out hitData, 1000))
        {
            if (hitData.collider.gameObject.tag != "Path" && hitData.collider.gameObject.tag != "Enemy" && hitData.collider.gameObject.tag != "Unit")
            {
                ...
                GameManager.Instance.DwarfSetPosition(dwarfType,this.transform.position);
            }
